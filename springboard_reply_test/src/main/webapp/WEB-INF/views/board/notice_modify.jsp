...
<div class="row">
	<div class="col-lg-12">
		<h1 class = "page-header">게시판 수정 페이지</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
	<div class="col-lg-12">
		<div class ="panel panel-default">
			...
			<div class="panel-heading">${board.bno } 번째 게시글 수정</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
			
				<form role="form" action="/board/notice_modify" method="post">
					<div class="row">
					...
					<button type="button" onclick="location.href='/board/notice_remove?bno=${board.bno}'" class ="btn btn-default">삭제</button>
